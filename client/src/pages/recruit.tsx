...
const timeline = [
  ...
  { time: "07:00", title: "積み込み・ルート出発", note: "配送物の確認・積み付け後、出発" },
  { time: "09:00", title: "午前の配送", note: "近距離ルートを中心に順番に納品対応" },
  { time: "12:00", title: "昼食休憩（1時間）", note: "ゆっくり休んでリフレッシュ" },
  { time: "13:00", title: "午後の配送", note: "長距離・遠方案件にも対応" },
  { time: "14:30", title: "配送完了・帰社", note: "お客様先での納品対応・運転日報の記録" },
  { time: "15:00", title: "車両清掃・翌日準備・退勤", note: "早期退勤で仕事とプライベートを両立" },
];
      ...
      <section className="bg-white py-12">
        <div className="overflow-hidden w-full">
          <div className="flex animate-recruit-slide" style={{ width: "max-content" }}>
            {[...recruitImgs, ...recruitImgs, ...recruitImgs, ...recruitImgs].map((img, i) => (
