  ...
  return <div className="bg-white text-[#0758c8]">
    <main className="relative" style={{ height: "500vh" }}>
      <div className="sticky top-0 h-[100svh] overflow-hidden">
        ...
        <Scene opacity={s1} className="items-center px-5 pt-20 sm:px-12"><div className="mx-auto w-full max-w-7xl"><p className="font-mono text-[9px] tracking-[.3em]">01 / MOVE</p><h1 className="mt-10 max-w-6xl font-serif text-[clamp(5rem,16vw,16rem)] leading-[.82] tracking-[-.12em]">運ぶ。</h1></div></Scene>
        <Scene opacity={s2} y={useTransform(progress, [.18, .4], [40, -20])} className="items-center px-5 pt-20 sm:px-12"><div className="mx-auto w-full max-w-7xl"><p className="font-mono text-[9px] tracking-[.3em]">02 / PROBLEM</p><h2 className="mt-10 font-serif text-[clamp(3rem,11vw,11rem)] leading-[.86] tracking-[-.11em]">今日の<span className="sm:hidden"><br /></span>トラックが、<br /><span className="ml-[6vw] sm:ml-[12vw]">見つからない。</span></h2></div></Scene>
        <Scene opacity={s3} scale={useTransform(progress, [.38, .6], [1.08, 1])} className="items-center px-5 sm:px-12"><div className="mx-auto w-full max-w-7xl"><p className="font-mono text-[9px] tracking-[.3em]">03 / SOLUTION</p><h2 className="mt-10 font-serif text-[clamp(3rem,10vw,10rem)] leading-[.86] tracking-[-.11em]">電話一本で、<br /><span className="ml-[6vw] sm:ml-[12vw]">トラック<span className="sm:hidden"><br /></span>手配します。</span></h2></div></Scene>
        <Scene opacity={s4} className="items-center bg-[#0758c8] px-5 text-white sm:px-12"><div className="mx-auto grid w-full max-w-7xl grid-cols-[auto_1fr] gap-8"><p className="font-mono text-[9px] tracking-[.25em] [writing-mode:vertical-rl]">04 / ALWAYS ON</p><div><p className="font-mono text-[10px] tracking-[.3em] text-white/65">24 HOURS / NATIONWIDE</p><p className="mt-8 font-serif text-[clamp(4rem,13vw,13rem)] leading-[.8] tracking-[-.12em]">24<br /><span className="ml-[12vw]">HOURS</span></p></div></div></Scene>
        <Scene opacity={s5} className="items-center px-5 sm:px-12"><div className="mx-auto w-full max-w-7xl"><p className="font-mono text-[9px] tracking-[.3em]">05 / CALL NOW</p><h2 className="mt-10 font-serif text-[clamp(3.4rem,12vw,12rem)] leading-[.82] tracking-[-.11em]">今、<br /><span className="ml-[6vw] sm:ml-[11vw]">電話する。</span></h2><a href={phoneHref} onClick={() => call("final_scene")} data-testid="link-lp-phone-final_scene" className="pointer-events-auto ml-[6vw] mt-10 inline-flex items-end gap-3 border-b-2 border-[#0758c8] pb-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 sm:ml-[11vw]"><Phone className="mb-2 h-6 w-6" strokeWidth={1.4} /><span><small className="block font-mono text-[9px] tracking-[.22em]">24H / TAP TO CALL</small><strong className="block font-mono text-[clamp(2.2rem,6vw,5.5rem)] leading-none tracking-[-.08em]">{phoneNumber}</strong></span><ArrowUpRight className="mb-2 h-5 w-5" /></a></div></Scene>
