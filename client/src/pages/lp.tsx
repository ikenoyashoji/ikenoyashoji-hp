  ...
  return <div className="bg-[#0758c8] text-white">
    <main className="relative" style={{ height: "800vh" }}>
      <div className="sticky top-0 h-[100svh] overflow-hidden">
        ...
        <Scene opacity={s1} className="items-center px-5 pt-20 sm:px-[6vw]"><BackdropWord large>MOVE</BackdropWord><div className="relative z-10 w-full -translate-y-[4vh]"><p className="font-mono text-[9px] tracking-[.3em]">01 / MOVE</p><h1 className="-ml-8 mt-10 max-w-6xl font-serif text-[clamp(5rem,16vw,16rem)] leading-[.82] tracking-[-.12em] sm:-ml-[4vw]">運ぶ。</h1></div><div aria-hidden="true" className="absolute bottom-7 left-1/2 z-10 flex -translate-x-1/2 items-start gap-3 sm:bottom-9"><span className="relative block h-14 w-px overflow-hidden bg-white/25"><span className="absolute left-0 top-0 h-5 w-px animate-bounce bg-white" /></span><span className="pt-0.5 font-mono text-[8px] tracking-[.28em] text-white/65 [writing-mode:vertical-rl]">SCROLL</span></div></Scene>
        <Scene opacity={s2} className="items-center px-5 pt-20 sm:px-[6vw]"><BackdropWord>MISSING</BackdropWord><div className="relative z-10 w-full -translate-y-[7vh]"><p className="font-mono text-[9px] tracking-[.3em]">02 / PROBLEM</p><h2 className="-ml-8 mt-10 font-serif text-[clamp(3rem,11vw,11rem)] leading-[.86] tracking-[-.11em] sm:-ml-[4vw]">今日の<span className="sm:hidden"><br /></span>トラックが、<br />見つからない。</h2></div></Scene>
