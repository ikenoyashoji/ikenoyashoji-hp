          ...
          <div className="relative mx-auto flex min-h-[650px] max-w-7xl items-center px-6 py-16 sm:min-h-[720px] sm:px-10 lg:px-16">
            <div className="max-w-xl">
              <AnimateIn>
                ...
                <h1 className="font-serif text-[2.55rem] font-bold leading-[1.12] tracking-[0.02em] text-[#0f2044] sm:text-6xl lg:text-[5.15rem]">
                  緊急のトラック手配。
                  <span className="mt-2 block text-[#164da3]">まずはお電話ください。</span>
                </h1>
