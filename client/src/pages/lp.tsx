  ...
  return <div className="bg-[#0758c8] text-white">
    <main className="relative" style={{ height: "900vh" }}>
      <div className="sticky top-0 h-[100svh] overflow-hidden">
        ...
        <Scene opacity={s1} className="items-center px-5 pt-20 sm:px-[6vw]"><BackdropWord large x={f1.wordX} scale={f1.wordScale}>MOVE</BackdropWord><motion.img src={womanFigure} alt="" aria-hidden="true" style={{ x: womanX, y: womanY, scale: womanScale, transformOrigin: "bottom center" }} className="absolute bottom-[5vh] right-[-18vw] z-[5] h-[72svh] w-auto object-contain object-bottom md:bottom-0 md:right-[18vw] md:h-[94svh]" /><CinematicCopy {...f1} className="-translate-y-[4vh]"><p className="font-mono text-[9px] tracking-[.3em]">01 / MOVE</p><h1 className="-ml-2 mt-10 max-w-6xl font-serif text-[6.5rem] leading-[.82] tracking-[-.12em] sm:-ml-[4vw] sm:text-[clamp(5rem,16vw,16rem)]">運ぶ。</h1></CinematicCopy><ScrollCue /></Scene>
