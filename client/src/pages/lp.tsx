  ...
  return <div className="bg-[#0758c8] text-white">
    <main className="relative" style={{ height: "800vh" }}>
      <div className="sticky top-0 h-[100svh] overflow-hidden">
        ...
        <Scene opacity={s4} className="items-center bg-white px-5 text-[#0758c8] sm:px-[6vw]"><BackdropWord blue>ALWAYS</BackdropWord><div className="relative z-10 grid w-full grid-cols-[auto_1fr] gap-8"><p className="font-mono text-[9px] tracking-[.25em] [writing-mode:vertical-rl]">04 / ALWAYS</p><div><p className="font-mono text-[10px] tracking-[.3em] text-[#0758c8]/65">ALWAYS</p><p className="-ml-8 mt-8 font-serif text-[clamp(4rem,14vw,14rem)] leading-[.95] tracking-[-.12em] sm:-ml-[5vw]">24<br /><span className="ml-[4vw]">HOURS</span></p></div></div><ScrollCue blue /></Scene>
