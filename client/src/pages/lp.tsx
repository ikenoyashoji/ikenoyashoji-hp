...
function MobileHero() {
  return (
    <section className="relative h-[100svh] min-h-[700px] w-full overflow-hidden bg-[radial-gradient(circle_at_72%_18%,#2b7eea_0%,#1265d4_34%,#0649ae_100%)] text-white md:hidden">
      ...
      <p className="absolute left-[53%] top-[196px] z-10 w-max -translate-x-1/2 whitespace-nowrap text-[38vw] font-black leading-none tracking-[-0.08em] text-white">
        運ぶ。
      </p>
...
function DesktopHero() {
  return (
    <section className="relative hidden h-[100svh] min-h-[100svh] w-full overflow-hidden bg-[radial-gradient(circle_at_72%_18%,#2b7eea_0%,#1265d4_34%,#0649ae_100%)] text-white md:block">
      ...
      <p className="absolute left-[55%] top-[160px] z-10 w-max -translate-x-1/2 whitespace-nowrap text-[clamp(13rem,26vw,24rem)] font-black leading-none tracking-[-0.08em] text-white">
        運ぶ。
      </p>
