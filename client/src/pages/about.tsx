          ...
          <AnimateIn>
            <div className="mb-16 text-center">
              ...
              <div className="space-y-6 text-gray-600 text-sm leading-[2.2] max-w-2xl mx-auto text-center">
                <p>私たちは、誰もが公平に力を発揮できる環境を整え、仕事を通じて人と出会い、関わり合い、様々な経験を重ねながら、人生そのものを豊かに育んでいく場をつくっています。</p>
                <p>物流を通して、すべての人の日常を支え、想いを運び、そっと寄り添う存在でありたい。<br />届けた一つひとつが、誰かの未来を切り拓き、幸せの連鎖を生み出す力になると信じています。</p>
                <p>また、私たちは人間らしさを何より大切にします。感謝、礼儀、誠実さを忘れずに、人として胸を張れる生き方を積み重ねていく。「ありがとう」の連鎖が、仕事の価値を生み、仲間との絆を深めます。</p>
                <p>特別な力に頼ることなく、誰もが小さな成功体験を積み重ねられる、温かく公正な組織を育み、変わり続ける社会の中で、仲間と会社の未来を築いていきます。</p>
                <p>そして私たちは、今までの価値観を尊重しながら、まだ見ぬ世界へ歩み続けます。新たな経験と価値観を重ね、豊かな未来を創り上げていきます。</p>
