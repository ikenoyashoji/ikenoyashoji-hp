          ...
          <AnimateIn>
            <div className="mb-16 text-center">
              ...
              <div className="space-y-6 text-gray-600 text-sm leading-[2.2] max-w-2xl mx-auto text-center">
                <p>私たちは、誰もが公平に力を発揮できる環境を整え、仕事を通じて人と出会い、関わり合い<br />様々な経験を重ねながら、人生そのものを豊かに育んでいく場をつくっています。</p>
                <p>物流を通して、すべての人の日常を支え、想いを運び、そっと寄り添う存在でありたい。<br />届けた一つひとつが、誰かの未来を切り拓き、幸せの連鎖を生み出す力になると信じています。</p>
                <p>また、私たちは人間らしさを何より大切にします。感謝、礼儀、誠実さを忘れずに<br />人として胸を張れる生き方を積み重ねていく。「ありがとう」の連鎖が<br />仕事の価値を生み、仲間との絆を深めます。</p>
                <p>特別な力に頼ることなく、誰もが小さな成功体験を積み重ねられる、温かく公正な組織を育み<br />変わり続ける社会の中で、仲間と会社の未来を築いていきます。</p>
                <p>そして私たちは、今までの価値観を尊重しながら、まだ見ぬ世界へ歩み続けます。<br />新たな経験と価値観を重ね、豊かな未来を創り上げていきます。</p>
                <p className="font-medium text-gray-700">池ノ谷商事は、「人を育て、想いを運び、未来へつながる豊かさを届け続けます。」</p>
              </div>
            </div>
          </AnimateIn>
          <AnimateIn>
            <div className="grid md:grid-cols-3 gap-px bg-gray-100">
              {[
                { title: "Mission", sub: "使命", body: "全ての人の人生を豊かにする為に\n物流を通じて日常を支え\n想いを運び、届けた一つひとつが誰かの幸せへとつながる\n連鎖を生み出し続ける。" },
                { title: "Vision", sub: "ビジョン", body: "すべての物流を、再現性ある\n仕組みで。誰がやっても\n成果が出る非属人的で自走する\n物流の未来を構造からつくる。" },
          ...
          <AnimateIn>
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="mt-10 pt-8 border-t border-gray-100 text-right">
                <p className="text-gray-400 text-xs mb-2">代表取締役</p>
