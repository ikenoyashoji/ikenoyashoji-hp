          ...
          <div className="relative">
            ...
            <div className="space-y-0">
              {[
                ...
                { year: "2023年12月", event: "愛川第一車庫（神奈川県愛甲郡愛川町中津7294）を開設" },
                { year: "2024年2月", event: "創業1周年。事業基盤をさらに強化", highlight: true },
                { year: "2024年4月", event: "一般貨物自動車運送事業 許可取得（関自貨第1201号）。自社運送事業を本格化" },
                { year: "2024年6月", event: "相模原車庫（神奈川県相模原市中央区田名4905）を開設" },
                { year: "2024年7月", event: "愛川倉庫（神奈川県愛甲郡愛川町中津250-1）を開設。保管事業へ進出" },
                { year: "2024年11月", event: "湘南営業所（神奈川県秦野市名古木157-12）を開設。湘南・西湘エリアへ事業拡大" },
                { year: "2025年2月", event: "創業2周年", highlight: true },
                { year: "2025年4月", event: "厚木営業所・厚木倉庫（神奈川県厚木市森の里紅葉台3-4）を開設" },
                { year: "2025年5月", event: "一般社団法人神奈川県トラック協会・愛甲商工会に加盟" },
              ].map((item, i) => (
