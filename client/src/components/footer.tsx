...
import footerBg from "@assets/スクリーンショット_2026-05-13_4.35.28_1778614533329.png";
    ...
    <footer className="relative text-white overflow-hidden">
      ...
      <div className="relative z-10 w-full px-12 py-7 flex items-center justify-between gap-8">
        ...
        <div className="flex flex-col items-center gap-1 flex-1">
          <p className="text-gray-300 text-[11px] tracking-wide">
        ...
        <div className="flex flex-col items-end gap-3 min-w-fit">
          <div className="flex items-center gap-4">
            ...
            <a href="#" aria-label="Instagram" className="text-gray-300 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path fill="none" stroke="currentColor" strokeWidth="1.5" d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><circle cx="17.5" cy="6.5" r="0.5" fill="currentColor"/></svg>
            </a>
            {/* TikTok */}
            ...
            {/* note */}
            <a href="#" aria-label="note" className="text-gray-300 hover:text-white transition-colors text-sm font-bold tracking-tight leading-none">
              n
            </a>
          </div>
