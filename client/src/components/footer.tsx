        ...
        <div className="flex flex-col items-end gap-2.5">
          <div className="flex items-center gap-4">
            ...
            <a href="#" aria-label="Instagram" className="text-white/80 hover:text-white transition-colors">
              <svg className="w-[27px] h-[27px]" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
            ...
            {/* note */}
            <a href="#" aria-label="note" className="text-white/80 hover:text-white transition-colors flex items-center justify-center w-[27px] h-[27px]">
              <span className="text-[22px] font-black leading-none" style={{ fontFamily: "'Georgia', serif" }}>n</span>
            </a>
          </div>
