          ...
          <div>
            <div className="mb-4">
              <div className="flex items-center gap-1 mb-1">
                <span className="text-blue-400 font-black text-xl italic">アクロス</span>
                <span className="text-red-400 font-black text-xl italic">物流</span>
              </div>
              <div className="text-gray-400 text-xs tracking-widest">アクロス物流株式会社</div>
            </div>
