      ...
      <div className="absolute inset-0 z-10 flex items-center px-16">
        <div className="w-full flex items-center justify-between gap-6">
          ...
          <div className="flex flex-col gap-2">
            <p className="text-white font-bold text-lg tracking-wider leading-none">株式会社池ノ谷商事</p>
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <div className="flex items-center gap-5">
              ...
              {/* note */}
              <a href="#" aria-label="note" className="text-white/80 hover:text-white transition-colors w-6 h-6 flex items-center justify-center">
                <span className="text-base font-black leading-none" style={{ fontFamily: "serif" }}>n</span>
              </a>
            </div>
