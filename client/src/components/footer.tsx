        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between md:gap-6">
          ...
          <div className="flex flex-col items-start md:items-end gap-2">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/80 hover:text-white transition-colors">
                <svg className="w-5 h-5 md:w-[27px] md:h-[27px]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/>
                </svg>
              </a>
              <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-white/80 hover:text-white transition-colors">
                <svg className="w-5 h-5 md:w-[27px] md:h-[27px]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/80 hover:text-white transition-colors">
              ...
              <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white/80 hover:text-white transition-colors">
                <svg className="w-5 h-5 md:w-[27px] md:h-[27px]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://note.com" target="_blank" rel="noopener noreferrer" aria-label="note" className="text-white/80 hover:text-white transition-colors flex items-center justify-center w-5 h-5 md:w-[27px] md:h-[27px]">
                <span className="text-lg md:text-[22px] font-black leading-none" style={{ fontFamily: "'Georgia', serif" }}>n</span>
              </a>
            </div>
