...
<p>物流コスト削減は一朝一夕にはできませんが、正しい方法を実践することで確実に効果が出ます。弊社では無料の物流コスト診断を実施しておりますので、お気軽にご相談ください。</p>`,
        ...
        authorNote: "アクロス物流 物流コンサルティング部",
      });

      await storage.createArticle({
        title: "トラックドライバー求人｜アクロス物流の待遇・福利厚生・1日の仕事の流れを公開",
        slug: "driver-recruitment-benefits",
        metaDescription: "アクロス物流のトラックドライバー求人情報。給与・休日・福利厚生など待遇面を詳しく紹介。未経験者歓迎、充実した研修制度あり。東京・関東エリアで募集中。",
        content: `<h2>アクロス物流でドライバーとして働く魅力</h2>
<p>私たちアクロス物流は、「ドライバーが誇りを持って働ける会社」を目指しています。単に荷物を運ぶだけでなく、社会インフラを支える重要な仕事として、一人ひとりのドライバーを大切にしています。</p>
...
<h2>まとめ</h2>
<p>アクロス物流では、現在積極的に仲間を募集しています。「安定した仕事がしたい」「ドライバーの仕事で成長したい」という方、ぜひご応募ください。</p>`,
        excerpt: "アクロス物流のトラックドライバー求人情報。給与・休日・福利厚生など待遇面を詳しく紹介。未経験者歓迎、充実した研修制度があります。",
        category: "採用情報",
...
export async function registerRoutes(httpServer: Server, app: Express): Promise<Server> {
  ...
  app.post("/api/admin/ai/generate", requireAdmin, async (req, res) => {
    ...
    const systemPrompt = `あなたは物流会社「アクロス物流株式会社」のSEO記事ライターです。E-E-A-Tを意識し、読者の検索意図に沿った高品質な記事を作成します。ターゲット読者は${targetLabel}です。
